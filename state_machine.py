...
def boss_attack(e):         #e가 time out인지 판단
    return e[0] == 'Boss_attack'

def boss_move(e):         #e가 time out인지 판단
    return e[0] == 'Boss_knight_diff_x'
...
def knight_is_dead(e):         #e가 time out인지 판단
    return e[0] == 'Knight_is_dead'
